...
public class GeneradorDePotencias {
    ...
    public static void generarPotencias(String[] lenguaje, int potenciaMaxima) {
        ...
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("output.txt"))) {
            ...
            JOptionPane.showMessageDialog(null, "Archivo output.txt creado exitosamente en " + System.getProperty("user.dir"));
    ...
    private static void calcularPotencia(String[] lenguaje, int potencia, String resultado, BufferedWriter writer) throws IOException {
        if (potencia == 0) {
